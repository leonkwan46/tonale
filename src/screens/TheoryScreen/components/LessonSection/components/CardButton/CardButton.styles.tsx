...
export const NodeDepth = styled.View<{ isLocked: boolean, isCompleted?: boolean }>(({ theme, isLocked, isCompleted }) => ({
  position: 'absolute',
  top: scale(3),
  left: scale(3),
  height: theme.device.isTablet ? scale(theme.components.cardButton.size * 0.8) : scale(theme.components.cardButton.size),
  width: theme.device.isTablet ? scale(theme.components.cardButton.size * 0.8) : scale(theme.components.cardButton.size),
...
export const NodeContentContainer = styled.View<{ isLocked: boolean, isCompleted?: boolean }>(({ theme, isLocked, isCompleted }) => ({
