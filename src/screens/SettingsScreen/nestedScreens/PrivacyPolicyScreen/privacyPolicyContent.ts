export const PRIVACY_POLICY_LAST_UPDATED = '14 March 2026'
...
export const PRIVACY_POLICY_SECTIONS: PrivacyPolicySection[] = [
  ...
  },
  {
    ...
    content:
      'This Privacy Policy applies to your use of the **Tonalè** mobile app (iOS and Android). The app may link to other websites or services (for example, "Buy me a coffee" or other donation links). We do not control how those third parties collect or use your data; please check their privacy policies before giving them any personal information.'
  },
  {
