...
export const stageOneLessons: Lesson[] = [
  ...
  {
    id: 'theory-stage-1-final',
    title: 'Stage 1 Test',
    description: 'Test all Stage 1 knowledge',
    isFinalTest: true,
    isPassed: false,
    exerciseConfig: {
      generatorType: 'theory-stage-1-final',
      questionsCount: 25,
      stage: 1,
      answerLayoutType: 'row'
    }
