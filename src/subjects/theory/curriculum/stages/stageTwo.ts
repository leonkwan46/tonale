...
export const stageTwoLessons: Lesson[] = [
  ...
  {
    id: 'theory-stage-2-final',
    title: 'Stage 2 Test',
    description: 'Test all Stage 2 knowledge',
    isFinalTest: true,
    isPassed: false,
    exerciseConfig: {
      generatorType: 'theory-stage-2-final',
      questionsCount: 30,
      stage: 2,
      answerLayoutType: 'row'
    }
...
export const stage2: Stage = {
  ...
  lessons: stageTwoLessons.map(lesson => ({ ...lesson, stageId: 'theory-stage-2' } as StageLesson)),
  order: 2,
  prerequisiteStages: ['theory-stage-1'],
