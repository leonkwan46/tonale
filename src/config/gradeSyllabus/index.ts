...
export {
    // Global
    ALL_MAJOR_SCALES,
    ALL_MELODIC_MINOR_SCALES,
    ALL_HARMONIC_MINOR_SCALES,
    // Grade 1
    GRADE_ONE_MAJOR_SCALES,
    GRADE_ONE_SCALES,
    // Grade 2
...
export {
    ...
    // Grade 4
    GRADE_FOUR_INTERVALS,
    // Grade 5
    GRADE_FIVE_INTERVALS,
...
export {
    // Grade 1
    GRADE_ONE_TIME_SIGNATURES,
    // Grade 2
    GRADE_TWO_TIME_SIGNATURES,
    // Grade 3
    GRADE_THREE_TIME_SIGNATURES,
    // Grade 4
...
export {
    ...
    GradeOneAccidentalSigns,
    GradeOneAccidentalSignsKeys,
    GradeOneArticulationSigns,
    GradeOneArticulationSignsKeys,
    GradeOneArticulationTerms,
    GradeOneArticulationTermsKeys,
    GradeOneDynamicSymbols,
    GradeOneDynamicSymbolsKeys,
    GradeOneExpressionTerms,
    GradeOneExpressionTermsKeys,
    GradeOnePerformanceTerms,
    GradeOnePerformanceTermsKeys,
    GradeOneTempoTerms,
    GradeOneTempoTermsKeys,
    // Grade 2
    GRADE_TWO_DYNAMIC_SYMBOLS,
    ...
    GradeTwoDynamicSymbols,
    GradeTwoDynamicSymbolsKeys,
    GradeTwoExpressionTerms,
    GradeTwoExpressionTermsKeys,
    GradeTwoItalianWords,
    GradeTwoItalianWordsKeys,
    GradeTwoModifierTerms,
    GradeTwoModifierTermsKeys,
    GradeTwoPerformanceTerms,
    GradeTwoPerformanceTermsKeys,
    GradeTwoTempoTerms,
    GradeTwoTempoTermsKeys,
    // Grade 3
    GRADE_THREE_ARTICULATION_TERMS,
    GRADE_THREE_DYNAMIC_SYMBOLS,
    GRADE_THREE_EXPRESSION_TERMS,
    GRADE_THREE_ITALIAN_WORDS,
    GRADE_THREE_MODIFIER_TERMS,
    GRADE_THREE_TEMPO_TERMS,
    GradeThreeArticulationTerms,
    GradeThreeArticulationTermsKeys,
    GradeThreeDynamicSymbols,
    GradeThreeDynamicSymbolsKeys,
    GradeThreeExpressionTerms,
    GradeThreeExpressionTermsKeys,
    GradeThreeItalianWords,
    GradeThreeItalianWordsKeys,
